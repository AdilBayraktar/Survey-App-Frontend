...
import { setAnswer2, setCurrentStep } from "../redux/slices/formSlice";
import {
  Button,
  FormControl,
  FormControlLabel,
...
const StepTwo = ({ randomData }) => {
  const dispatch = useDispatch();
  const [answer, setAnswer] = useState("");
  const slicedData = randomData[1];

  const onSubmit = (e) => {
    e.preventDefault();
    dispatch(
      setAnswer2({ questionText: slicedData.questionText, answer: answer })
    );
